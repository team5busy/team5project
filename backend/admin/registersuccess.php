		...
		<div class="row">
			...
			<div class="col-md-8 submenu">
				<ul class="nav navbar-nav">
					<li></li>
					<li class="active"><a href="shop/shop_add.php">Add Shop</a></li>
					<li><a href="shop/shop_list.php">Shop List</a></li>
			</div><!-- submenu -->
		</div>
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 mybody">
				<form method="POST" class="myform">		
					<h3 style="color:green;"> Successfully registered! </h3><br />
					<input name="btnHome" type="submit" class="btn "value="Go home">
				</form>
			</div><!-- content -->	
