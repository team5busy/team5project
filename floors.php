			...
			<div class="  col-m-on">
				...
				<div class="in-line">
					...
					<?php 
						...
						$query3 = "select * from SHOP where FLOOR_NO =".$_REQUEST['id'].""; 
									...
									{	
										...
										echo '<tr>';
												$idValue = $row3['USERNAME'];
														...
														echo '<td class="categoryform"><a href="shopitems.php?id='.$idValue.'"><h3 class="textSize"> '.$rowCount.'</td></a></h3>';
														echo '<td class="categoryform"><a href="shopitems.php?id='.$idValue.'"><h3 class="textSize"> '.$row3['SHOP_NAME'].'</td></a></h3>';
														echo '<td class="categoryform"><a href="shopitems.php?id='.$idValue.'"><h3 class="textSize">'.$row3['FLOOR_NO'].'</td></a></h3>';
														echo '<td class="categoryform"><a href="shopitems.php?id='.$idValue.'"><h3 class="textSize">';
