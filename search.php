			...
			<div class="  col-m-on">
				...
				<div class="in-line">
					...
					<div class="lady-on">
						...
						<?php
							$search = $_REQUEST['id'];
							$query3 = "select * from PRODUCT where PRODUCT_NAME LIKE '%".$search."%' or PRODUCT_NAME LIKE '%".$search."' or PRODUCT_NAME LIKE '".$search."%' order by PRODUCT_ID";                    
							...
							while($row3 = oci_fetch_assoc($result3))
							{
								echo '<div class="col-md-4 itembind">';
									...
									if(isset($_SESSION['Customer'])){
										...
										echo '<a href="login.php?searchid='.$search.'">Add to Cart </a>';
									}
									echo '</span>';
								echo '</div>';
							}
